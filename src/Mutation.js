  ...
  constructor (options = { mutationObserverInit: undefined }, ...args) {
    ...
    if (this.mutationObserverInit && (this.mutationObserverInit.attributes || this.mutationObserverInit.characterData || this.mutationObserverInit.childList)) {
      ...
      if (this.shadowRoot && this.mutationObserverInit.attributes) {
        ...
        /** @return {void} */
        this.mutationObserveStart = target => {
          // @ts-ignore
          if (restObserverInit.childList || restObserverInit.characterData) this.mutationObserver.observe(target || this.shadowRoot, restObserverInit)
          // @ts-ignore
          this.mutationObserver.observe(target || this, { attributeFilter, attributes, attributeOldValue })
        }
      } else {
        /** @return {void} */
